...
- If the type of speech is textual monologue, there will be only one speaker and the message will not be preceded by any gender or name of the speaker. The output must be in JSON format and the structure of the output must be the same as we had with the previous options. In this case we should not pay attentions to any words provided, in case there will be, because it will be textual monologue and the content will be provided in the description.
